...
export default function Testimonials({title, headline, image1Src, image2Src, image3Src, buttons = true}: TestimonialsProps = {}) {
  const testimonials = [
    { id: 1, src: image1Src },
    { id: 2, src: image2Src },
    { id: 3, src: image3Src },
  ...
  return (
    <div className="flex flex-col justify-center max-w-4xl mx-auto w-[90%] h-screen">
      <h2 className="text-xl font-bold text-center mb-2">{headline ? headline : null}</h2>
      <h2 className="text-3xl font-bold text-center mb-8">{title ? title : "TESTIMONIALS"}</h2>
      {buttons ? <div className="flex justify-center space-x-4 mb-8">
